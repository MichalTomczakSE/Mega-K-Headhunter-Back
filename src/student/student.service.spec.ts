...
describe('StudentService', () => {
  ...
  beforeAll(async () => {
    studentDetails = await StudentService.prototype.getSingleStudentFullDetails(
      'f9751776-9ed4-42c5-9e4a-930f9d8bc9gg',
    );
  });
  ...
  jest
    ...
    .mockImplementation(
      async (id: string): Promise<GetSingleStudentFullDetailsResponse> => {
        return {
          id: id,
          email: 'test@test.com',
